...
export default interface IChatController {
    handleNewUserMessage(socket: Server, conversationId: string, message: string): Promise<void>;
    handleEmplNewMessage(socket: Server, conversationId: string, message: string): Promise<void>;
